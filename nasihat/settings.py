...
CSRF_TRUSTED_ORIGINS = ['https://40tavsiya.uz']
...
MIDDLEWARE = [
    ...
    'nasihat.middleware.CustomSecurityMiddleware',
]
...
REST_FRAMEWORK = {
    # Remove or comment out the authentication classes
    ...
    # You can keep throttling if needed
